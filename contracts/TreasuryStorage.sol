...
contract TreasuryStorage is TreasuryAdminStorage {
    ...
    address public junOracle;

    // price
    uint256 public junPriceOne;
    uint256 public previousRoundJUNPrice;
    ...
    uint256 public junbDepletionFloorPercent;
