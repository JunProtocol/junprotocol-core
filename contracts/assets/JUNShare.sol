...
contract JUNShare is kERC20, Operator {
    ...
    uint256 public startTime = 1631602800; // 2021 09 14 07:00 UTC
    uint256 public endTime = startTime + VESTING_DURATION; // 2023 09 14 07:00 UTC
    ...
    constructor(uint256 _startTime) public kERC20("Jun Share Token", "JUNS") {
        startTime = _startTime;
        devFundLastClaimed = startTime;
        endTime = startTime + VESTING_DURATION;
        _mint(msg.sender, INITIAL_MINT); // mint JUNS for initial pools deployment
        devFund = msg.sender;
    }
