...
contract JUN is kERC20, Operator {
    ...
    /**
     * @notice Constructs the JUN ERC-20 contract.
     */
    constructor() public kERC20("Jun Token", "JUN") {
        // Mints JUN to contract creator for initial pool setup
        _mint(msg.sender, INITIAL_MINT);
    }

    /**
     * @notice Operator mints JUN to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of JUN to mint to
